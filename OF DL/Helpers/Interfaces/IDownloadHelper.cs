...
namespace OF_DL.Helpers
{
    public interface IDownloadHelper
    {
        ...
        Task<bool> DownloadArchivedPostDRMVideo(string ytdlppath,
        ...
        Task<bool> DownloadMessageDRMVideo(string ytdlppath,
                                           ...
                                           Dictionary<string, int> users,
                                           Config config);
        Task<bool> DownloadMessageMedia(string url,
                                        string folder,
                                        long media_id,
                                        ProgressTask task,
                                        string filenameFormat,
                                        ...
                                        Dictionary<string, int> users,
                                        Config config);
        Task<bool> DownloadPostDRMVideo(string ytdlppath,
                                        string mp4decryptpath,
                                        string ffmpegpath,
                                        string user_agent,
                                        string policy,
                                        ...
                                        Dictionary<string, int> users,
                                        Config config);
        Task<bool> DownloadPostMedia(string url,
                                     string folder,
                                     long media_id,
                                     ProgressTask task,
                                     string filenameFormat,
                                     ...
                                     Dictionary<string, int> users,
                                     Config config);
        Task<bool> DownloadPurchasedMedia(string url,
                                          string folder,
                                          long media_id,
                                          ProgressTask task,
                                          string filenameFormat,
                                          ...
                                          Dictionary<string, int> users,
                                          Config config);
        Task<bool> DownloadPurchasedMessageDRMVideo(string ytdlppath,
                                                    string mp4decryptpath,
                                                    string ffmpegpath,
                                                    string user_agent,
                                                    string policy,
                                                    ...
                                                    Dictionary<string, int> users,
                                                    Config config);
        Task<bool> DownloadPurchasedPostDRMVideo(string ytdlppath,
                                                 string mp4decryptpath,
                                                 string ffmpegpath,
                                                 string user_agent,
                                                 string policy,
                                                 ...
                                                 Dictionary<string, int> users,
                                                 Config config);
        Task<bool> DownloadPurchasedPostMedia(string url,
                                              string folder,
                                              long media_id,
                                              ProgressTask task,
                                              string filenameFormat,
